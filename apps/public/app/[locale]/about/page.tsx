  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <h1 className="text-4xl font-semibold tracking-normal">About Juris</h1>
        <p className="mt-4 text-lg text-muted-foreground">
          Juris gives platform teams a stable way to grow product surfaces
          without coupling every team to one deployable.
        </p>
