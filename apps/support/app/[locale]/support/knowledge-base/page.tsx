...
export default async function ProductPage({
  ...
  const session = await requirePermission("support:read", { redirectTo: `/${locale}/console` });
  ...
  return (
    <AppShell
      ...
      breadcrumb={getBreadcrumb(locale, "Knowledge Base")}
    >
        <PageHeader
          title="Knowledge Base"
          description="Ticket, knowledge base, and contact workflows for service teams. This view focuses on knowledge base."
